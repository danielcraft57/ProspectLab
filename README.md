...
- **Graph entreprises** : visualisation des liens externes (fiches ↔ domaines tiers), surcouche Material 3 (rail de stats, dock d’actions, plein écran), mini-scrape des sites liés, API dédiée ; documentation dans `docs/guides/GRAPH_ENTREPRISES.md`
