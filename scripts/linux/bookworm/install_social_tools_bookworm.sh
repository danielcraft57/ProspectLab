...
# Installation d'outils OSINT orientés réseaux sociaux sur Debian Bookworm / RPi
# Exécution : bash scripts/linux/install_social_tools_bookworm.sh
...
echo "[*] Installation outils social OSINT (Bookworm) terminée."
