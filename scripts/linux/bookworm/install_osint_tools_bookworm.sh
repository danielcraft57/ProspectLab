...
# Installation d'un set d'outils OSINT sur Debian Bookworm / RPi (arm64)
# Exécution : bash scripts/linux/bookworm/install_osint_tools_bookworm.sh
...
echo "[*] Installation OSINT (Bookworm) terminée."
